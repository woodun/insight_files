...
output=/stor1/hwang07/paper_collection/nb_asap_more_apps_baseline.txt
mother_dir=/stor1/hwang07/nb_asap/baseline
...
for configs_stor1 in tsp_address_exp_gtoswl48_alloff_wattch1_nb
do
