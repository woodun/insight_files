...
output=/stor1/hwang07/SNR_collection/coverage_tsp_fig15

#specify your config path in stor1
for configs_stor1 in coverage25_tsp_gto48 coverage40_tsp_gto48 coverage44_tsp_gto48 coverage50_tsp_gto48
do
