...
source=/stor2/hwang07/coverage_dynamic_S
output=/stor1/hwang07/SNR_collection/coverage25_dynamic2

#specify your config path in stor1
for configs_stor1 in coverage25_dynamic_gto48 coverage25_dynamic_lrr48 coverage25_dynamic_RR48
do
