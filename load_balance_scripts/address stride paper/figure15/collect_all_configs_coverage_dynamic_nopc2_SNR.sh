...
output=/stor1/hwang07/SNR_collection/coverage25_dynamic_nopc2

#specify your config path in stor1
for configs_stor1 in coverage25_dynamic_nopc_gto48 coverage25_dynamic_nopc_lrr48 coverage25_dynamic_nopc_RR48
do
