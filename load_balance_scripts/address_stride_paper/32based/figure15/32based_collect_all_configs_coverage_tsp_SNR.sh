...
source=/stor2/hwang07/32based_coverage_tsp_S
output=/stor1/hwang07/32based_SNR_collection/32based_coverage_tsp

#specify your config path in stor1
for configs_stor1 in 32based_coverage50_tsp_gto48 32based_coverage25_tsp_gto48
do
