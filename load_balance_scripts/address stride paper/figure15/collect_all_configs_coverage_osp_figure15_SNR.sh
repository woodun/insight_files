...
output=/stor1/hwang07/SNR_collection/coverage_osp_fig15

#specify your config path in stor1
for configs_stor1 in coverage25_osp_gto48 coverage40_osp_gto48 coverage44_osp_gto48 coverage50_osp_gto48
do
