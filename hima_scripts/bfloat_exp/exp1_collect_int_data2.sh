...
output=/sciclone/pscr/hwang07/bfloat_analysis/collection/all_results_int.txt
mother_dir=/sciclone/pscr/hwang07/bfloat_analysis/results_int
...
for statistics in 'bytes_ones_int:' 'bytes_ones_new:' 'bytes_flips_int:'  'bytes_flips_new:'
do
