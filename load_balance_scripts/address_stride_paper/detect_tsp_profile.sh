...
#cp -r /stor1/hwang07/insight_files/insight_template /stor2/hwang07/tsp_profile_S/tsp_profile_gto48
#cd osp_profile_gto48
#sh setup_ALL.sh tsp_profile_gto48
#sh setup_ALL.sh tsp_profile_lrr48
#sh setup_ALL.sh tsp_profile_RR48
#sh setup_ALL.sh tsp_profile_swl1
###################################################################################
