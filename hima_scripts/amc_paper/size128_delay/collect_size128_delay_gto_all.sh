...
output=/sciclone/data10/hwang07/GPU_RESEARCH/amc_collection/size128_delay_gto_access_num.txt
mother_dir=/sciclone/data10/hwang07/GPU_RESEARCH/amc/sizes_delay

for statistics in 'overall accesses all:' 'overall activations all:' 'bw_util=' 'echo in delay queue all:' 'number of global reads only activations:' 'accesses from global reads only activations:' 'gpu_tot_ipc =' 'L1D_total_cache_miss_rate =' 'L2_total_cache_miss_rate =' 'removed all:'
do
