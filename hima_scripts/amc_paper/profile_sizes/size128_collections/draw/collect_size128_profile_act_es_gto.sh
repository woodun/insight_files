...
output=/sciclone/data10/hwang07/GPU_RESEARCH/amc_collection/size128_profile_act_es.txt
...
for statistics in 'e1 act_temp:' 'e2 act_temp:' 'e3 act_temp:' 'e4 act_temp:' 'e5 act_temp:' 'e6 act_temp:' 'e7 act_temp:' 'e8 act_temp:'
do
#13
cd $mother_dir
cd $configs_stor1
