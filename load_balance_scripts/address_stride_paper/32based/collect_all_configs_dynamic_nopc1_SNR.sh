...
source=/stor1/hwang07/dynamic_nopc_S
output=/stor1/hwang07/SNR_collection/dynamic_nopc1

#specify your config path in stor1
for configs_stor1 in dynamic_nopc_gto48 dynamic_nopc_lrr48 dynamic_nopc_RR48
do
