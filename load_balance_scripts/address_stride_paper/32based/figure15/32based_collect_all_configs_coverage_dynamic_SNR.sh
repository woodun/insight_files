...
source=/stor2/hwang07/32based_coverage_dynamic_S
output=/stor1/hwang07/32based_SNR_collection/32based_coverage_dynamic

#specify your config path in stor1
for configs_stor1 in 32based_coverage50_dynamic_gto48 32based_coverage25_dynamic_gto48
do
