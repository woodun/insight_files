...
#cp -r /stor1/hwang07/insight_files/insight_template /stor1/hwang07/warp_partition_osp_S/wp2_osp_coverage50_gto48
#cp -r /stor1/hwang07/insight_files/insight_template /stor1/hwang07/warp_partition_osp_S/wp4_osp_coverage50_gto48
#cd wp0_osp_coverage50_gto48
#sh setup_ALL.sh wp0_osp_coverage50_gto48
#sh setup_ALL.sh wp0_osp_coverage50_lrr48
#sh setup_ALL.sh wp0_osp_coverage50_RR48
#sh setup_ALL.sh wp2_osp_coverage50_gto48
#sh setup_ALL.sh wp2_osp_coverage50_lrr48
#sh setup_ALL.sh wp2_osp_coverage50_RR48
#sh setup_ALL.sh wp4_osp_coverage50_gto48
#sh setup_ALL.sh wp4_osp_coverage50_lrr48
#sh setup_ALL.sh wp4_osp_coverage50_RR48
###################################################################################
