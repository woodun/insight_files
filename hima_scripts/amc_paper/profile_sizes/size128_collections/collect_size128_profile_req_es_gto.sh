...
output=/sciclone/data10/hwang07/GPU_RESEARCH/amc_collection/size128_profile_req_es.txt
...
#grep -o "temp_bwutil:[ ]*[-eE\+0-9\.]*" profile_output.txt | sed -e "s/temp_bwutil:[ ]*//g" | xargs printf "%s "
for statistics in 'e1 req_temp:' 'e2 req_temp:' 'e3 req_temp:' 'e4 req_temp:' 'e5 req_temp:' 'e6 req_temp:' 'e7 req_temp:' 'e8 req_temp:' 'req_temp_act:'
do
