...
cp -r /stor1/hwang07/insight_files/insight_template /stor2/hwang07/coverage_osp_nopc_S/coverage25_tsp_nopc_gto48
cd /stor2/hwang07/coverage_osp_nopc_S/coverage25_tsp_nopc_gto48
sh setup_ALL.sh coverage25_tsp_nopc_gto48
cp -r /stor1/hwang07/insight_files/insight_template /stor2/hwang07/coverage_osp_nopc_S/coverage40_tsp_nopc_gto48
cd /stor2/hwang07/coverage_osp_nopc_S/coverage40_tsp_nopc_gto48
sh setup_ALL.sh coverage40_tsp_nopc_gto48
cp -r /stor1/hwang07/insight_files/insight_template /stor2/hwang07/coverage_osp_nopc_S/coverage44_tsp_nopc_gto48
cd /stor2/hwang07/coverage_osp_nopc_S/coverage44_tsp_nopc_gto48
sh setup_ALL.sh coverage44_tsp_nopc_gto48
cp -r /stor1/hwang07/insight_files/insight_template /stor2/hwang07/coverage_osp_nopc_S/coverage50_tsp_nopc_gto48
cd /stor2/hwang07/coverage_osp_nopc_S/coverage50_tsp_nopc_gto48
