...
output=/sciclone/data10/hwang07/GPU_RESEARCH/amc_collection/size128_delays_readonly_count.txt
mother_dir=/sciclone/data10/hwang07/GPU_RESEARCH/amc/size128_delays

for statistics in 'readonly count 128 and more all:'
do
...
#############################
#15
#removed: 2DCONV FDTD-2D GRAMSCHM SYR2K 2DCONV_EMBOSS
#GESUMMV MVT 2MM 3MM SYRK ATAX BICG 2DCONV_BLUR 3DCONV GEMM
for benchmark in GESUMMV MVT 2MM 3MM SYRK ATAX BICG 2DCONV_BLUR 3DCONV GEMM
do
